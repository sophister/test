/*
 * @require common:widget/oui/arale/dialog/1.3.3/dialog.css
 */

define('common:widget/oui/arale/dialog/1.3.3/dialog-1.3.3', ['require', 'exports', 'module', 'common:widget/oui/lib/jquery/1.9.1/jquery', 'common:widget/oui/arale/overlay/1.1.2/overlay', 'common:widget/oui/arale/overlay/1.1.2/mask', 'common:widget/oui/arale/events/1.1.0/events', 'common:widget/oui/arale/templatable/0.9.1/templatable'],function(require, exports, module) {
   //require('arale/dialog/1.3.3/dialog.css');
    var $ = require('common:widget/oui/lib/jquery/1.9.1/jquery'),
        Overlay = require('common:widget/oui/arale/overlay/1.1.2/overlay'),
        mask = require('common:widget/oui/arale/overlay/1.1.2/mask'),
        Events = require('common:widget/oui/arale/events/1.1.0/events'),
        Templatable = require('common:widget/oui/arale/templatable/0.9.1/templatable'),
       ...
       // Implements: Templatable,
        ...
        attrs: {
            ...
            template: '<div class="ui-dialog">'+
    				  '<div class="ui-dialog-close" title="关闭本框" data-role="close"></div>'+
   					  '<div class="ui-dialog-content" data-role="content"></div>'+
					  '</div>',
