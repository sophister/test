define('common:widget/oui/arale/calendar/0.9.0/calendar', ['require', 'exports', 'module', 'common:widget/oui/lib/jquery/1.9.1/jquery', 'common:widget/oui/arale/moment/2.1.0/moment', 'common:widget/oui/arale/calendar/0.9.0/base-calendar', 'common:widget/oui/arale/calendar/0.9.0/date-column', 'common:widget/oui/arale/calendar/0.9.0/month-column', 'common:widget/oui/arale/calendar/0.9.0/year-column', 'common:widget/oui/arale/calendar/0.9.0/base-column'],function(require, exports, module) {
  var $ = require('common:widget/oui/lib/jquery/1.9.1/jquery');
  var moment = require('common:widget/oui/arale/moment/2.1.0/moment');

  var BaseCalendar = require('common:widget/oui/arale/calendar/0.9.0/base-calendar');
  var DateColumn = require('common:widget/oui/arale/calendar/0.9.0/date-column');
  var MonthColumn = require('common:widget/oui/arale/calendar/0.9.0/month-column');
  var YearColumn = require('common:widget/oui/arale/calendar/0.9.0/year-column');
  var template = [
  ...
  Calendar.BaseColumn = require('common:widget/oui/arale/calendar/0.9.0/base-column');
