define('common:widget/oui/pages/borrow/index', ['require', 'common:widget/oui/lib/jquery/1.9.1/jquery', 'common:widget/oui/lib/city/1.0.1/new-city', 'common:widget/oui/arale/dialog/1.3.3/dialog', 'common:widget/oui/lib/handlebars/1.0.0/handlebars', 'common:widget/oui/arale/sticky/1.2.1/sticky', 'common:widget/oui/widgets/widgets', 'common:widget/oui/protocol', 'common:widget/oui/components/components.jscomponents'],function (require) {

  var $ = require('common:widget/oui/lib/jquery/1.9.1/jquery'),
    pc = require('common:widget/oui/lib/city/1.0.1/new-city'),
    ...
    sticky = require('common:widget/oui/arale/sticky/1.2.1/sticky'),
...
/*$form.on("focusout keyup",":text,[type='password'],[type='file'],textarea",function(){
  ...
  new Dialog({
    ...
    var m1 = $('#J_m1').attr('data');
    var m2 = $('#J_m2').attr('data');
    var m3 = $('#J_m3').attr('data');
    var res = calc({
      "repayDate": m2,
      "borrowAmount": m1,
      "yearRate": m3,
    ...
    var data = res.calc();
    $('#J_monthre').text('￥' + t._commaFloat(data.monthlyRepay + m1 * 0.003));
