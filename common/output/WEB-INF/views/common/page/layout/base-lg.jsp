...
<!DOCTYPE html>
<fis:html framework="common:static/js/require.js">
    <fis:head>
        <meta charset="UTF-8">
        ...
        <link rel="stylesheet" type="text/css" href="/static/common/css/base_3d64263.css">

        <!--header中的css-->
        <fis:block name="block_head_css"></fis:block>

        <!--[if lte IE 8]>
        <script src="/static/common/js/html5_0ce8f35.js"></script>
        <![endif]-->
    ...
    <fis:require name="common:page/layout/base.jsp" />
    <!-- THX FOR FIS -->
</fis:html>
