define('common:widget/oui/pages/auth/login', ['require', 'common:widget/oui/lib/jquery/1.9.1/jquery', 'common:widget/oui/rsa/index', 'common:widget/oui/widgets/widgets', 'common:widget/oui/lib/handlebars/1.0.0/handlebars', 'common:widget/oui/lib/mailSuggest/0.0.1/mailSuggest'],function (require) {
  ...
  var MailSuggest = require('common:widget/oui/lib/mailSuggest/0.0.1/mailSuggest');
