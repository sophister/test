...
define('common:widget/oui/widgets/form', ['require', 'exports', 'module', "common:widget/oui/lib/jquery/1.9.1/jquery", "lib/validation/1.11.1/jquery.validate"],function (require, exports, module) {
  var $ = require("common:widget/oui/lib/jquery/1.9.1/jquery");
  require("lib/validation/1.11.1/jquery.validate");
  var jQuery = $;
  // require("ui-poptip");
  var form = {};
  form.err = {
