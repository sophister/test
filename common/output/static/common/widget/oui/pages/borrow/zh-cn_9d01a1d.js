define('common:widget/oui/pages/borrow/zh-cn', function(require, exports, module) {
// Chinese
plupload.addI18n({
   'Select files' : '选择文件',
   ...
   'Upload element accepts only %d file(s) at a time. Extra files were stripped.': '上传的列表中只接受 %d 文件的时间。多余的文件被取消了',
