        ...
        postprocessor: {
            amd: {
                paths: {
                    ...
                    'donut' : 'common:widget/ui/donut/donut.js',
                    ...
                    'tab':'common:widget/oui/widgets/tab.js',
                    'list':'common:widget/oui/widgets/list.js',
                    'common':'common:widget/oui/common.js',
                    'protocol':'common:widget/oui/protocol.js',
                    'transactionlist':"user:widget/transactionlist/transactionlist.js",
                    'ui-counter': 'common:widget/oui/lib/counter/0.0.1/jquery.counter-analog.css',
                    'ui-poptip': 'common:widget/oui/alice/poptip/1.1.1/poptip.css',
