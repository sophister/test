define('common:widget/oui/pages/auth/register', ['require', 'common:widget/oui/lib/jquery/1.9.1/jquery', 'common:widget/oui/rsa/index', 'common:widget/oui/arale/dialog/1.3.3/dialog', 'common:widget/oui/widgets/widgets'],function (require) {
...
//          });
    ...
    if($(".J_error_tips")){
      $(".J_error_tips").delay(3000).slideUp(function () {
        $(this).html('');
      });
    }
