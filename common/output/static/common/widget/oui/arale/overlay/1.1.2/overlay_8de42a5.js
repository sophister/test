define('common:widget/oui/arale/overlay/1.1.2/overlay', ['require', 'exports', 'module', 'common:widget/oui/lib/jquery/1.9.1/jquery', 'common:widget/oui/arale/position/1.0.1/position', 'common:widget/oui/arale/shim/1.0.2/iframe-shim', 'common:widget/oui/arale/widget/1.1.1/widget'],function(require, exports, module) {

    var $ = require('common:widget/oui/lib/jquery/1.9.1/jquery'),
        Position = require('common:widget/oui/arale/position/1.0.1/position'),
        Shim = require('common:widget/oui/arale/shim/1.0.2/iframe-shim'),
        Widget = require('common:widget/oui/arale/widget/1.1.1/widget');
